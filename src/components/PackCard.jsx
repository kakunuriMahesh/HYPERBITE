...
//   const { packItems, addPackToCart, updatePackQuantity } = useCart();
...
//       {/* Status/Status Badge for customized packs */}
...
//                  <span style={{ color: '#2e7d32', fontWeight: 600 }}>{useLanguage().t('delivering_to')} {useCart().pincode}</span>
//                  <button 
//                     onClick={() => useCart().setPincode('')}
//                     style={{ background: 'none', border: 'none', textDecoration: 'underline', cursor: 'pointer', color: '#666' }}
//                  >
//                      {useLanguage().t('change')}
//                  </button>
//              </div>
//         ) : (
...
//                  <input 
//                     type="text" 
//                     placeholder={useLanguage().t('enter_pincode')}
//                     id={`pincode-${pack.id}`}
//                     style={{
//                         flex: 1,
//                         padding: '8px',
...
//                     onKeyDown={(e) => {
//                         if (e.key === 'Enter') {
//                             useCart().validateAndSetPincode(e.target.value);
//                         }
//                     }}
//                  />
//                  <button
//                     onClick={() => {
//                         const val = document.getElementById(`pincode-${pack.id}`).value;
//                         useCart().validateAndSetPincode(val);
//                     }}
//                     style={{
//                         padding: '8px 12px',
//                         backgroundColor: '#333',
...
//             alignItems: 'center',
//             justifyContent: 'center',
//             backgroundColor: useCart().pincode ? '#000' : '#ccc',
//             color: '#fff',
//             borderRadius: '8px',
//             border: 'none',
//             cursor: useCart().pincode ? 'pointer' : 'not-allowed',
//             fontSize: '16px',
//             fontWeight: 600,
