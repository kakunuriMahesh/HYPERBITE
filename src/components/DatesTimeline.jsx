...
const DatesTimeline = ({
  ...
  useEffect(() => {
    ...
    const updateDimensions = () => {
      const aspectRatio = 3971 / 1202; // original SVG ratio
      ...
      const extraScroll = window.innerHeight * 1.5; // enough to cover loops and keep dot visible
  ...
  useGSAPContext(() => {
    ...
    ScrollTrigger.create({
      trigger: wrapper,
      start: "top 80%", // 🎯 Mobile/desktop: animation starts when section enters viewport
