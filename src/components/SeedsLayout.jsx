        ...
        <div className="relative top-[250px] m-auto w-[1200px] h-[600px]">
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center">
            <img
              ...
              style={{
                left: breakpoint === 'mobile' ? '10.2%' : '46.2%',
                top: breakpoint === 'mobile' ? '20px' : '100px',
                width: breakpoint === 'mobile' ? '80px' : '140px',
              }}
              alt=""
            />
            <img
            ...
            {Array.from({ length: 18 }).map((_, i) => (
              <div
                ...
                style={{
                  ...
                  width: breakpoint === 'mobile' ? 4 : i % 3 === 0 ? 24 : i % 2 === 0 ? 14 : 8,
                  height: breakpoint === 'mobile' ? 4 : i % 3 === 0 ? 24 : i % 2 === 0 ? 14 : 8,
                }}
              />
            ))}
          </div>
